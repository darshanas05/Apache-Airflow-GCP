...
# setting the parameters for notification, retry delay and other parameters
...
CLUSTER_NAME = 'spark-airflow-gcp'
PROJECT_ID = 'spark-airflow-gcp-403306'
REGION = 'us-central1'
CLUSTER_CONFIG = {
    'master_config': {
...
# defining the resourses for the spark instance to be used
...
# setting the flow of the process to be followed
